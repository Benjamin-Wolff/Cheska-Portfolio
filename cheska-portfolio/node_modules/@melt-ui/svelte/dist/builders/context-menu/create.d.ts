...
export declare function createContextMenu(props?: CreateContextMenuProps): {
    ...
    elements: {
        menu: import("../../internal/helpers/index.js").ExplicitBuilderReturn<[Readable<boolean>, WithGet<import("svelte/store").Writable<string | HTMLElement | null | undefined>>, WithGet<import("svelte/store").Writable<string>>, WithGet<import("svelte/store").Writable<string>>], (node: HTMLElement) => MeltActionReturn<ContextMenuEvents['menu']>, ([$isVisible, $portal, $menuId, $triggerId]: [boolean, string | HTMLElement | null | undefined, string, string]) => {
            readonly role: "menu";
        ...
        arrow: import("../../internal/helpers/index.js").ExplicitBuilderReturn<WithGet<import("svelte/store").Writable<number | undefined>>, import("svelte/action").Action<any, any, Record<never, any>>, ($arrowSize: number | undefined) => {
            'data-arrow': boolean;
            style: string;
        }, string>;
        separator: import("../../internal/helpers/index.js").ExplicitBuilderReturn<[WithGet<import("svelte/store").Writable<import("../../internal/types.js").Orientation>>, WithGet<import("svelte/store").Writable<boolean>>], import("svelte/action").Action<any, any, Record<never, any>>, ([$orientation, $decorative]: [import("../../internal/types.js").Orientation, boolean]) => {
            role: string;
        ...
        createSubmenu: (args?: import("../menu/types.js")._CreateSubmenuProps | undefined) => {
            ...
            elements: {
                subTrigger: import("../../internal/helpers/index.js").ExplicitBuilderReturn<[{
                    ...
                    get: () => boolean;
                    destroy?: (() => void) | undefined;
                }, WithGet<import("svelte/store").Writable<boolean>>, WithGet<import("svelte/store").Writable<string>>, WithGet<import("svelte/store").Writable<string>>], (node: HTMLElement) => MeltActionReturn<"click" | "focusin" | "focusout" | "keydown" | "pointerleave" | "pointermove">, ([$subOpen, $disabled, $subMenuId, $subTriggerId]: [boolean, boolean, string, string]) => {
                ...
                subMenu: import("../../internal/helpers/index.js").ExplicitBuilderReturn<[Readable<boolean>, WithGet<import("svelte/store").Writable<string>>, WithGet<import("svelte/store").Writable<string>>], (node: HTMLElement) => MeltActionReturn<"focusout" | "keydown" | "pointermove">, ([$subIsVisible, $subMenuId, $subTriggerId]: [boolean, string, string]) => {
                    readonly role: "menu";
                    readonly hidden: true | undefined;
                    readonly style: string;
                    readonly id: string;
                ...
                subArrow: import("../../internal/helpers/index.js").ExplicitBuilderReturn<WithGet<import("svelte/store").Writable<number>>, import("svelte/action").Action<any, any, Record<never, any>>, ($arrowSize: number) => {
                    'data-arrow': boolean;
                    style: string;
                }, string>;
            };
