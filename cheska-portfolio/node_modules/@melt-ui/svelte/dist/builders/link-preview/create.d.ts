...
export declare function createLinkPreview(props?: CreateLinkPreviewProps): {
    ...
    elements: {
        ...
        content: import("../../internal/helpers/index.js").ExplicitBuilderReturn<[Readable<boolean>, WithGet<import("svelte/store").Writable<string | HTMLElement | null>>, WithGet<import("svelte/store").Writable<string>>], (node: HTMLElement) => MeltActionReturn<LinkPreviewEvents['content']>, ([$isVisible, $portal, $contentId]: [boolean, string | HTMLElement | null, string]) => {
        ...
        arrow: import("../../internal/helpers/index.js").ExplicitBuilderReturn<WithGet<import("svelte/store").Writable<number>>, import("svelte/action").Action<any, any, Record<never, any>>, ($arrowSize: number) => {
            'data-arrow': boolean;
            style: string;
        }, string>;
    };
