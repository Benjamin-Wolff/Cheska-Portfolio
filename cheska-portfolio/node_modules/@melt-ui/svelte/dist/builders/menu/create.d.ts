...
export declare function createMenuBuilder(opts: _MenuBuilderOptions): {
    ...
    trigger: import("../../internal/helpers/index.js").ExplicitBuilderReturn<[WithGet<Writable<boolean>>, WithGet<Writable<string>>, WithGet<Writable<string>>], (node: HTMLElement) => MeltActionReturn<MenuEvents['trigger']>, ([$rootOpen, $rootMenuId, $rootTriggerId]: [boolean, string, string]) => {
    ...
    menu: import("../../internal/helpers/index.js").ExplicitBuilderReturn<[import("svelte/store").Readable<boolean>, WithGet<Writable<string | HTMLElement | null | undefined>>, WithGet<Writable<string>>, WithGet<Writable<string>>], (node: HTMLElement) => MeltActionReturn<MenuEvents['menu']>, ([$isVisible, $portal, $rootMenuId, $rootTriggerId]: [boolean, string | HTMLElement | null | undefined, string, string]) => {
        readonly role: "menu";
    ...
    arrow: import("../../internal/helpers/index.js").ExplicitBuilderReturn<WithGet<Writable<number | undefined>>, import("svelte/action").Action<any, any, Record<never, any>>, ($arrowSize: number | undefined) => {
        'data-arrow': boolean;
        style: string;
    }, string>;
    options: {
    ...
    createSubmenu: (args?: _CreateSubmenuProps) => {
        ...
        elements: {
            ...
            subMenu: import("../../internal/helpers/index.js").ExplicitBuilderReturn<[import("svelte/store").Readable<boolean>, WithGet<Writable<string>>, WithGet<Writable<string>>], (node: HTMLElement) => MeltActionReturn<MenuEvents['submenu']>, ([$subIsVisible, $subMenuId, $subTriggerId]: [boolean, string, string]) => {
                readonly role: "menu";
                readonly hidden: true | undefined;
                readonly style: string;
                readonly id: string;
            ...
            subArrow: import("../../internal/helpers/index.js").ExplicitBuilderReturn<WithGet<Writable<number>>, import("svelte/action").Action<any, any, Record<never, any>>, ($arrowSize: number) => {
                'data-arrow': boolean;
                style: string;
            }, string>;
        };
    ...
    separator: import("../../internal/helpers/index.js").ExplicitBuilderReturn<[WithGet<Writable<import("../../internal/types.js").Orientation>>, WithGet<Writable<boolean>>], import("svelte/action").Action<any, any, Record<never, any>>, ([$orientation, $decorative]: [import("../../internal/types.js").Orientation, boolean]) => {
        role: string;
