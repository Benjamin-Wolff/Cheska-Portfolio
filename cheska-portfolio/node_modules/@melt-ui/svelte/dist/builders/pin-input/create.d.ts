...
export declare function createPinInput(props?: CreatePinInputProps): {
    ...
    elements: {
        ...
        hiddenInput: import("../../internal/helpers/index.js").ExplicitBuilderReturn<[import("svelte/store").Readable<string>, import("../../internal/helpers/index.js").WithGet<import("svelte/store").Writable<string | undefined>>], import("svelte/action").Action<any, any, Record<never, any>>, ([$valueStr, $nameStore]: [string, string | undefined]) => {
            value: string;
