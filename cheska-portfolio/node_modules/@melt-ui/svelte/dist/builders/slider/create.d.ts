...
export declare const createSlider: (props?: CreateSliderProps) => {
    elements: {
        root: import("../../internal/helpers/index.js").ExplicitBuilderReturn<[import("../../internal/helpers/withGet.js").WithGet<import("svelte/store").Writable<boolean>>, import("../../internal/helpers/withGet.js").WithGet<import("svelte/store").Writable<import("./types.js").SliderOrientation>>, import("../../internal/helpers/withGet.js").WithGet<import("svelte/store").Writable<"ltr" | "rtl">>], import("svelte/action").Action<any, any, Record<never, any>>, ([$disabled, $orientation, $dir]: [boolean, import("./types.js").SliderOrientation, "ltr" | "rtl"]) => {
            dir: "ltr" | "rtl";
        ...
        thumbs: import("../../internal/helpers/index.js").ExplicitBuilderArrayReturn<(node: HTMLElement) => MeltActionReturn<SliderEvents['thumb']>, NonEmptyArray<{
        ...
        ticks: import("../../internal/helpers/index.js").ExplicitBuilderArrayReturn<import("svelte/action").Action<any, any, Record<never, any>>, {
