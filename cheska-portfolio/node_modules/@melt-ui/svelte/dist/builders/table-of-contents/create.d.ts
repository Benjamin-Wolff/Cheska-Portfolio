...
export declare function createTableOfContents(args: CreateTableOfContentsArgs): {
    elements: {
        item: import("../../internal/helpers/index.js").ExplicitBuilderReturn<import("../../internal/helpers/withGet.js").WithGet<import("svelte/store").Writable<number[]>>, (node: HTMLAnchorElement) => {
            destroy: () => void;
