...
export declare function builderArray<S extends Stores, A extends Action<any, any>, R extends object[], Name extends string>(name: Name, args: BuilderArrayArgs<S, A, R>): ExplicitBuilderArrayReturn<A, R, Name>;
type BuilderArrayStore<A extends Action<any, any>, R extends object[], Name extends string> = Readable<{
    [K in keyof R]: R[K] & {
        [K in `data-melt-${Name}`]: '';
    } & {
        action: A;
...
export type ExplicitBuilderArrayReturn<A extends Action<any, any>, R extends object[], Name extends string> = BuilderArrayStore<A, R, Name> & A;
